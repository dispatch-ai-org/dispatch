...
|---|---|---|
| Codex included ChatGPT allocation | Existing live Luna/low and Terra/medium direct tasks, durable clarification and apply/drift checks in [Phase 4](phase4-dogfood-release.md); this candidate revalidates deterministic core/CLI/PTY fixtures | Historical resolved identities; observed model identity remained unknown. No fresh live call or current account validation in this pass. |
